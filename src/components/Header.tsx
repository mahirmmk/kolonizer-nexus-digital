      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-gradient">Kolonizer</h1>
              <p className="text-xs text-muted-foreground">Real Business Solutions</p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <div className="flex items-center space-x-4 text-sm">
              <div className="flex items-center space-x-1 text-muted-foreground">
                ...
                <span>+91 755 490 2000</span>
              </div>
              <div className="flex items-center space-x-1 text-muted-foreground">
                <Mail className="w-4 h-4" />
                <span>contact@kolonizer.com</span>
              </div>
            </div>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <nav className="lg:hidden mt-4 pb-4 border-t border-primary/10">
